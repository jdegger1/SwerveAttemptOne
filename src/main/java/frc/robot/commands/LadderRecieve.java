...
public class LadderRecieve extends Command {
  /** Creates a new LadderRecieve. */
 private final LadderSubsystem ladderSub;
  private final PIDController m_PidController;

  private double limiter;

  public LadderRecieve(LadderSubsystem ladderSub, double limiter) {
    ...
    m_PidController.setSetpoint(LadderConstants.kLiftRecieveSetPoint);
